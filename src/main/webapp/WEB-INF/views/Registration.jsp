...
<html lang="en">
	...
	<body class="light-gray-bg">
		<div class="templatemo-content-widget templatemo-login-widget white-bg">
	        ...
	        <form action="validate" method="post" class="templatemo-login-form">
	        	...
	        	<div class="form-group">
	        		<div class="input-group">
		        		<div class="input-group-addon"><i class="fa fa-user fa-fw"></i></div>	        		
		              	<input type="text" name="mail" class="form-control" placeholder="email@service.com">           
		          	</div>	
	        	</div>
	        	<div class="form-group">
	        		<div class="input-group">
		...
		<div class="templatemo-content-widget templatemo-login-widget templatemo-register-widget white-bg">
			<p>Already a member? <strong><a href="LoginPage" class="blue-text">Log in now!</a></strong></p>
		</div>
	</body>
</html>